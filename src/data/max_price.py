...
df = pd.read_csv(
    r"C:\Users\vivar\PycharmProjects\Russia Real Estate2021\data\external\all_v2.csv"
)
...
def максимальная_стоимость_по_региону(data):
    ...
    объединенные_данные = pd.merge(
        макс_стоимость_по_региону, data, on=["region", "price"], how="left"
    )
